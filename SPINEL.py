        ...
        with col8:
            ...
            if PO_toggle == True:
                ...
                if po_model == "March-Dollase":
                    st.session_state.params["baseline"] = st.number_input("baseline", value=0.00, step=0.1, format="%.2f")
                    st.session_state.params["R"] = st.number_input("R", value=1, step=0.10, format="%.2f")
